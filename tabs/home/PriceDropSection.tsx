...
const PriceDropSection: React.FC<PriceDropSectionProps> = ({ products, onAdd, onViewAll }) => {
  return (
    <div className="relative bg-[#fdf0e1] -mx-3 px-3 pt-0 pb-6 mb-6 overflow-hidden">
      {/* Gradient transition at top - continues seamlessly from CrazyDealSection's pink end */}
      <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#fdf0e1] to-[#fdf0e1] pointer-events-none"></div>
